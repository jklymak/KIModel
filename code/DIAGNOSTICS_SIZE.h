...
C  and "diagSt_size" (statistics-diags) since values here are deliberately small.
      ...
      INTEGER    diagSt_size
      PARAMETER( ndiagMax = 20 * Nr + 2 )
      PARAMETER( numlists = 12, numperlist = 50, numLevels=2*Nr )
      PARAMETER( numDiags = 20*Nr + 2 )
      PARAMETER( nRegions = 0 , sizRegMsk = 1 , nStats = 0 )
      PARAMETER( diagSt_size = 0 )
